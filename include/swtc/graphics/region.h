...
SWT_PUBLIC wresult w_region_create_elliptic(w_region* region,w_rect* rect);
...
SWT_PUBLIC wresult w_region_add_elliptic(w_region* region,w_rect *rect);
...
SWT_PUBLIC wresult w_region_subtract_elliptic(w_region* region,w_rect* rect);
