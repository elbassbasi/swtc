...
enum {
	W_TEXTSTYLE_MASK_METRICS = 1 << 0,
	W_TEXTSTYLE_MASK_RISE = 1 << 1,
	W_TEXTSTYLE_MASK_FONT = 1 << 2,
	W_TEXTSTYLE_MASK_FOREGROUND = 1 << 3,
	W_TEXTSTYLE_MASK_BACKGROUND = 1 << 4,
	W_TEXTSTYLE_MASK_UNDERLINE = 1 << 5,
	W_TEXTSTYLE_MASK_STRIKEOUT = 1 << 6,
	...
	W_TEXTSTYLE_UNDERLINE,
	W_TEXTSTYLE_STRIKEOUT,
}
;
