...
enum {
	...
	W_DRAG = 1,
	W_TRAVERSE_NONE = 0,
	W_TRAVERSE_ESCAPE = 1 << 1,
	W_TRAVERSE_RETURN = 1 << 2,
	W_TRAVERSE_TAB_PREVIOUS = 1 << 3,
	W_TRAVERSE_TAB_NEXT = 1 << 4,
	W_TRAVERSE_ARROW_PREVIOUS = 1 << 5,
	W_TRAVERSE_ARROW_NEXT = 1 << 6,
	W_TRAVERSE_MNEMONIC = 1 << 7,
	W_TRAVERSE_PAGE_PREVIOUS = 1 << 8,
	W_TRAVERSE_PAGE_NEXT = 1 << 9,
	W_GESTURE_BEGIN = 1 << 1,
	W_GESTURE_END = 1 << 2,
